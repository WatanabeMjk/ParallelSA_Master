...
func main() {
	...
	//var route int = C.buildRoute(mapData,numberOfCities)
	//var initialT float = 100.0
	//var finalT float = 0.1
	//var coolingRate float = 0.9
	route **int = calloc(51,sizeof(&mapData[0][0]));

	rand.Seed(time.Now().UnixNano())
	//fmt.Printf("%f\n",C.totalDistance(route,numberOfCities))
	//C.sa(route, numberOfCities, initialT, finalT, n, coolingRate)
	//fmt.Printf("%f\n",C.totalDistance(route,numberOfCities))
